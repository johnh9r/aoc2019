defmodule IntCodeDoublePlus do
  ...
  * support list of input value to be consumed by opcode 3
  * support single output value to be generated by opcode 4
  ...
  def execute(xs, inputs \\ [1])
  def execute([], _), do: []
  def execute(xs, inputs), do: _execute(xs, 0, inputs)

  @spec _execute([integer], integer, integer, integer) :: {integer, [integer]}
  defp _execute(xs, i, inputs, output \\ 0xcafebabe) do
    ...
    case op do
      ...
      1 ->
        ...
        |> _execute(i + insn_sz, inputs, output)
      ...
      3 ->
        ...
        [latest_input | remaining_inputs] = inputs
        store_at(xs, st_off, latest_input)
        |> _execute(i + insn_sz, remaining_inputs, output)
      ...
      4 ->
        ...
        _execute(xs, i + insn_sz, inputs, output_value)
      ...
      5 ->
        ...
        if load_param1.(xs, ld_off) != 0 do
          _execute(xs, load_param2.(xs, target), inputs, output)
        else
          _execute(xs, i + insn_sz, inputs, output)
        end
