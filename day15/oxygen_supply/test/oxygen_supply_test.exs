defmodule OxygenSupplyTest do
  use ExUnit.Case
  doctest OxygenSupply
  ...
  setup do
    ...
    # from running part 1 w/ truly random algo
    # start point was northern deadend at centre
    # 41 rows x 41 columns = 1_681 tiles
    # "*" marks oxygen supply detected
    my_map = """
       ### ####### ################### ####### 
      #...#.......#...................#.......#
      #.#.#.###.#.#.#######.#########.#######.#
  ...
  test "(part 2) correctly processes personal challenge", context do
    assert OxygenSupply.calc_timesteps_to_ubiquitous_oxygen_supply(context[:map_pt2]) == 406
  end
end
